...
public class Inicial extends javax.swing.JFrame {
    ...
    private void ButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRegistrarActionPerformed
        ...
        if (BoxCompra.isSelected()) {
            ...
            float valorInvestido = Float.parseFloat(FieldValorInvestido.getText());
            float valorNaCompra = Float.parseFloat(FieldValorAtual.getText());
            
            c.inserirRegistro(nome, Tipo, FieldDataEHora.getText(), FieldMoeda.getText(), valorInvestido, valorNaCompra, 0, null, null);
            ...
            try {
                ...
                float valorInvestido = Float.parseFloat(FieldValorInvestido.getText());
                float valorNaCompra = Float.parseFloat(FieldValorNaCompra.getText());
                float valorNaVenda = Float.parseFloat(FieldValorNaVenda.getText());

                c.inserirRegistro(nome, Tipo, FieldDataEHora.getText(), FieldMoeda.getText(), valorInvestido, valorNaCompra, valorNaVenda, FieldDataDaCompra.getText(), FieldDataDaVenda.getText());
